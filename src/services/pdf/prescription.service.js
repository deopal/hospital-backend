    ...
    try {
      ...
      const doc = new PDFDocument({
        ...
        info: {
          ...
          Creator: 'HealOrbit Hospital Management System'
        }
      });
...
function drawFooter(doc, doctor, appointment) {
  ...
  doc.fontSize(8)
     ...
     .font('Helvetica')
     .text(
       'This prescription is digitally generated by HealOrbit Hospital Management System. Please follow the prescribed medication as directed by your doctor. In case of any adverse reactions, consult your doctor immediately.',
       pageMargin,
       pageHeight - 55,
       {
